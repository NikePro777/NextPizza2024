  ...
  return (
    <div className={className}>
      ...
      <div className="flex flex-col gap-4">
        <FilterCheckbox text="Можно собирать" value="3" />
        <FilterCheckbox text="Новинки" value="4" />
      </div>
      ...
      <div className="mt-5 border-t border-y-neutral-100 py-6 pb-7">
        ...
        <div className="flex gap-3 mb-5">
          <Input type="number" placeholder="0 ₽" min={0} max={1000} defaultValue={500} step={10} />
          <Input type="number" min={100} max={1000} placeholder="1000 ₽" step={10} />
        </div>
